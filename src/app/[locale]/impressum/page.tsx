...
export default async function ImpressumPage({
  ...
  const doc = await loadMdxFile({ locale: 'de', slug: 'impressum' });

  return (
    <div className="mx-auto max-w-3xl px-6 sm:px-8 py-24">
      <h1 className="text-3xl font-bold tracking-tight leading-tight">{String(doc.frontmatter.title ?? 'Impressum')}</h1>
